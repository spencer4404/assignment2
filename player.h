 ...
 */
int add_card(struct player *target, struct card *new_card); // DONE
 ...
 *  returns: return 0 if no error, non-zero otherwise
 */
int remove_card(struct player *target, struct card *old_card); // DONE
 ...
 */
const char *check_add_book(struct player *target); // DONE
 ...
 */
int search(struct player *target, const char *rank); // DONE
 ...
 */
int transfer_cards(struct player *src, struct player *dest, const char *rank, char *transferred_cards); // DONE
 ...
 */
int game_over(struct player *target); // DONE
 ...
 */
int reset_player(struct player *target); // DONE
 ...
 */
char *computer_play(struct player *target); // DONE
 ...
 */
char *user_play(struct player *target); // DONE
